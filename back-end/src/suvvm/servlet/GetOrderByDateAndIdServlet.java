...
/**
 * Servlet implementation class GetOrderByDateAndIdServlet
 */
@WebServlet("/GetOrderByDateAndIdServlet")
public class GetOrderByDateAndIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetOrderByDateAndIdServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "SELECT * FROM `order_"+ shopid +"` WHERE to_days(bgtime) = to_days('"+date+"')";
